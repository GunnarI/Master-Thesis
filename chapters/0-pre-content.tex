...
Furthermore, it looks at the ability of the model to generalize, firstly, between separate sessions of the same subject, and secondly between different subjects.
The goal is to accurately predict \ac{KJM} during regular gait of healthy individuals using sequences of \ac{EMG} data from multiple muscles of the lower limbs.
