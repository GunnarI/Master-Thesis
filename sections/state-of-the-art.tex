...
Some EMG-drive NMS models have been created to estimate muscle force and consequently joint torque from measured EMG together with joint angles. 
Some examples are the models described by  \citeauthor{Lloyd2003} \cite{Lloyd2003}, and \citeauthor{Sartori2012a} \cite{Sartori2012a} and used by CEINMS \cite{Pizzolato2015}. 
