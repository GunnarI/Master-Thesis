...
\begin{enumerate}
    ...
    \item Training set: \textit{Subject01/Both, Subject02/Both,} and \textit{Subject06/Session1}\\
            Testing set: \textit{Subject06/Session2}\\
            Evaluating if additional data from different subjects improves the performance from case 1.
    \item Training set: \textit{Subject01/Both} and \textit{Subject06/Both}\\
            Testing set: \textit{Subject02/Both, Subject03,} and \textit{Subject05}\\
            Looking at the ability to generalize across subjects.
    \item Training set: \textit{Subject02/Both} and \textit{Subject06/Both}\\
            Testing set: \textit{Subject01/Both, Subject03,} and \textit{Subject05}\\
            Evaluating if this compares to case 3, i.e. how sensitive is the model to which subjects it trains on.
    \item Training set: \textit{Random 80\% of all the usable data}\\
...
\end{enumerate}
In all the case, the validation set was selected as random $10\%$ of the training set.
