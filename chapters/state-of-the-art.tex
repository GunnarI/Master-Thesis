...
The weights can be used to set the importance 
Exspeciftensivicrs or joints to be fitted accurately.
...
\end{figure}
 markee research has been done of on inverse dynamics and it is widely used in clinical applications such as, for example, gait analysis in rehabilitation \cite{Erdemir2007,Buchanan2004,Pizzolato2015}.
...
This facilitates building a conventional \ac{NN}, layer-wise, in a TensorFlow graph.
