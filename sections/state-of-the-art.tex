...
The amount of torque produces for any given motion depends on the control system of the exoskeleton.
Many different methods have been researched and implemented towards goal of providing a good control system that provides exactly the assist that the user wants and/or needs.
The key to that goal is to estimate or predict the joint torque associated with a certain motion performed by the user.

This chapter discusses the state of the art of exoskeleton control systems and joint torque and/or muscle force prediction models.
...
\subsection{Kinetics: Methods, models, and data acquisition}
...
Inverse-dynamics is the use of kinematics and reaction forces, e.g. motion capture and force plate data from a motion lab, to calculate joint torques estimations.
